...
def get_data(filtered_appraisal_payouts):
	"""
	Generate data rows from appraisal payout data for USD RTGS transfer
	"""
	...
	for item in detail_items:
		...
		detail_rows.append({
            ...
            "file_total": emp_info.get("employee_name", ""),  # Beneficiary Name
...
def get_appraisal_payout_details(payout_ids):
	"""Get appraisal payout item details for USD currency"""
	if not payout_ids:
		return []
